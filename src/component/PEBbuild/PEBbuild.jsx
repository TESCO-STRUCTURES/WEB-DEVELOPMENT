    ...
    <section id="peb-build" className="peb-bld">
      <div className="container peb-bld__inner">
        ...
        <div className="peb-bld__visual">
          <img src={buildImg} alt="Tesco Structure PEB site" className="peb-bld__visual-img" />
        </div>

        <form className="peb-bld__form" onSubmit={onSubmit} noValidate>
          ...
          <input type="hidden" name="_subject" value="New PEB enquiry — Tesco Structures website" />
          <input type="hidden" name="_template" value="table" />
          <input type="hidden" name="_captcha" value="false" />
          <input type="hidden" name="_source" value="PEB page" />
          ...
          <button type="submit" className="peb-bld__btn" disabled={status === 'sending'}>
            {btnLabel}
          </button>
        </form>
