  ...
  return (
    <section id="all-build" className="all-bld">
      <div className="container all-bld__inner">
        ...
        <form className="all-bld__form" onSubmit={onSubmit} noValidate>
          ...
          <input type="hidden" name="_subject" value="New Roofing enquiry — Tesco Structures website" />
          <input type="hidden" name="_template" value="table" />
          <input type="hidden" name="_captcha" value="false" />
          <input type="hidden" name="_source" value="All Type of Roofing page" />
          ...
          <button type="submit" className="all-bld__btn" disabled={status === 'sending'}>
            {btnLabel}
          </button>
        </form>
